...
public class MainActivity extends AppCompatActivity {
    ...
    public void goEjercicio14(View v) {
        startActivity(new Intent(MainActivity.this, Ejercicio14.class));
    }

    public void goEjercicio16(View v) {
        startActivity(new Intent(MainActivity.this, Ejercicio16.class));
    }

    public void goEjercicio18(View v) {
        startActivity(new Intent(MainActivity.this, Ejercicio18.class));
    }

    public void goEjercicio20(View v) {
        startActivity(new Intent(MainActivity.this, Ejercicio20.class));
    }

    public void goEjercicio22(View v) {
        startActivity(new Intent(MainActivity.this, Ejercicio22.class));
    }

    public void goEjercicio24(View v) {
